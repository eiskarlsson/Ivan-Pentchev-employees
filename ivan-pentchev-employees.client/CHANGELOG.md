...
- Create Angular project with ng: `ng new ivan-pentchev-employees.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`ivan-pentchev-employees.client.esproj`).
